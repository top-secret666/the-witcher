...
public final class ShopItem {
    ...
    public final boolean setCatalog;
    public final Rectangle bounds = new Rectangle();

    public ShopItem(String name, String priceLabel, boolean setCatalog, String dukeLine,
                      String[] statLines, Texture icon) {
        this.name = name;
