...
public final class ShopStatGlyphs {
    ...
    private static void drawShield(Graphics2D g, int x, int y) {
        ...
        g.drawLine(x + 6, y, x + 7, y + 2);
        g.drawLine(x + 7, y + 2, x + 5, y + 7);
        g.drawLine(x + 5, y + 7, x + 2, y + 7);
        g.drawLine(x + 2, y + 7, x, y + 2);
        g.drawLine(x, y + 2, x + 1, y);
        g.drawLine(x + 1, y, x + 3, y);
        g.drawLine(x + 3, y + 1, x + 3, y + 6);
    }

    private static void drawLightning(Graphics2D g, int x, int y) {
        g.drawLine(x + 5, y, x + 3, y + 3);
        g.drawLine(x + 3, y + 3, x + 5, y + 3);
        g.drawLine(x + 5, y + 3, x + 2, y + 7);
        g.drawLine(x + 4, y + 1, x + 3, y + 1);
    }

    private static void drawSign(Graphics2D g, int x, int y) {
        g.drawLine(x + 3, y + 1, x + 5, y + 3);
        g.drawLine(x + 5, y + 3, x + 3, y + 5);
