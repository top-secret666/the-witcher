...
public final class BossQuestBriefingScript {
  ...
  public static NoticeContent noticeFor(BossEntry boss) {
    ...
    return new NoticeContent(
        ...
        name.toUpperCase(),
        "Угроза: высокая",
        "Хутор у Старого Брода: в чаще бродит тень в человеческом "
            + "обличии. Скот пропадает, дети не выходят за ограду. "
            + "Свидетели зовут зверя «" + name + "». Устранить угрозу.",
        "250 крон и право на трофеи",
        "");
  }
