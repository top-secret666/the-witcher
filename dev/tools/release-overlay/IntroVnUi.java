...
/**
 * EXE overlay: intro hides Auto; chapter boss VN uses {@link #layoutChapterVnButtons}.
 */
public final class IntroVnUi {
    ...
    /** Intro + chapter VN: full toolbar with Auto. */
    public static ButtonLayout layoutVnButtons(int sw, int sh, int currentEntry) {
        return layoutChapterVnButtons(sw, sh, currentEntry);
    }

    /** Boss briefing / encounter: full toolbar with Auto. */
    public static ButtonLayout layoutChapterVnButtons(int sw, int sh, int currentEntry) {
