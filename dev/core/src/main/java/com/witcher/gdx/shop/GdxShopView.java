...
/**
 * LibGDX-отрисовка лавки — порт логики {@link com.witcher.ui.shop.swing.ShopSwingView}.
 */
public final class GdxShopView {
    ...
    private void drawHud(SpriteBatch batch, ShopLayout layout, float alpha, float slideY) {
        ...
        if (assets.dukeSealIconScaled != null) {
            int sealW = com.witcher.ui.shop.view.ShopViewConstants.HUD_DUKE_SEAL_W;
            int sealH = com.witcher.ui.shop.view.ShopViewConstants.HUD_DUKE_SEAL_H;
            int margin = com.witcher.ui.shop.view.ShopViewConstants.HUD_SEAL_MARGIN;
        ...
        int crownW = com.witcher.ui.shop.view.ShopViewConstants.HUD_CROWN_W;
        int crownH = com.witcher.ui.shop.view.ShopViewConstants.HUD_CROWN_H;
