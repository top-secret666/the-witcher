...
import static com.witcher.ui.shop.view.ShopViewConstants.HUD_H;
...
import static com.witcher.ui.shop.view.ShopViewConstants.DIALOG_TEXT_ZONE;
import static com.witcher.ui.shop.view.ShopViewConstants.PANEL_BOTTOM_MARGIN;
import static com.witcher.ui.shop.view.ShopViewConstants.VIRTUAL_H;

/**
 * LibGDX-ассеты лавки — аналог {@link com.witcher.ui.shop.swing.ShopAssetCache}.
 */
public final class GdxShopRuntimeAssets implements ShopRuntimeAssets {
    ...
    public final int dukeSealSize = Math.max(
        com.witcher.ui.shop.view.ShopViewConstants.HUD_DUKE_SEAL_W,
        com.witcher.ui.shop.view.ShopViewConstants.HUD_DUKE_SEAL_H);
